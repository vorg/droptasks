...
updateCalendar = function() {
  var day, node, tagIndex, task, taskLabel, taskNode, _i, _len, _ref, _results;
  ...
  for (_i = 0, _len = _ref.length; _i < _len; _i++) {
    ...
    _results.push((function() {
      ...
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        ...
        _results1.push($('#calendar.columns').eq(0).append(taskNode));
      }
      return _results1;
    })());
  }
...
deserialize = function(data) {
  var line, lines, newNode, nodesInProject, projectName, task, _i, _len;
