...
deserialize = function(data) {
  ...
  for (_i = 0, _len = lines.length; _i < _len; _i++) {
    ...
    if (isProject(line)) {
      ...
      _results.push(parseNodeTags(newNode));
    }
  }
  return _results;
};
